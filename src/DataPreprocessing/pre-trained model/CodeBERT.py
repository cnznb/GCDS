# -*- encoding = utf-8 -*-
"""
@description: Using CodeBERT to generate text vectors for each field in dataset
@date: 2022/9/4
@File : CodeBERT.py
@Software : PyCharm
"""
...
model_path = 'microsoft/codebert-base'  # sys.argv[1]  # CodeBERT预训练模型目录
...
def solve(path):
    ...
    with open(path + '\\field_range.csv', 'r') as fp:
        ...
        for line in lines:
            ...
            with open(path+'\\codeEmbedding\\codeBERT.csv', 'a', newline='') as csv_file:
