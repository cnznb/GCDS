# -*- encoding = utf-8 -*-
"""
@description: Using GraphCodeBERT to generate text vectors for each field in dataset
@date: 2022/9/4
@File : DT.py
@Software : PyCharm
"""
...
model_path = 'D:\\workspace\\EC\\graphcodebert-base' # sys.argv[1]  # GraphCodeBERT预训练模型目录
...
def solve(path):
    ...
    with open(path + '\\field_range.csv', 'r') as fp:
        ...
        for line in lines:
            ...
            with open(path+'\\codeEmbedding\\graphCodeBERT.csv', 'a', newline='') as csv_file:
